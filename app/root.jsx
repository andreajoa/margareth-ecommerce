...
export async function loader({context}) {
  ...
  return {
    ...
    apiVersion: '2025-07',
    // Não buscar cart no root loader - deixar o cart route cuidar disso
    cart: null,
  };
}
...
export default function App() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      window.__revalidateRoot = () => revalidator.revalidate();
    }
  }, [revalidator]);
  
  const env = data?.env || {
    PUBLIC_STORE_DOMAIN: 'brinqueteando.myshopify.com',
    PUBLIC_STOREFRONT_API_TOKEN: 'f4519cf3a3a10b4fccca0df4b0a464e1'
  };
  const apiVersion = data?.apiVersion || '2025-07';
