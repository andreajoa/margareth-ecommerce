...
function cleanDesc(desc) {
  ...
  var c = desc;
  // Remove blocos CSS tipo .classe { ... }
  while (c.match(/[.#@][a-zA-Z][^{]*{[^}]*}/)) {
    c = c.replace(/[.#@][a-zA-Z][^{]*{[^}]*}/g, '');
  }
  // Remove propriedades CSS soltas tipo font-family: valor;
  c = c.replace(/[a-zA-Z-]+s*:s*[^;{}
]+;/g, '');
  // Remove chaves
  c = c.replace(/[{}]/g, '');
  // Remove palavras-chave CSS comuns
  ...
  // Remove valores numericos com unidades
  ...
  // Se sobrou pouco texto, mensagem padrao
