      ...
      <main role="main" aria-label="BrinqueTEAndo - Loja TEA, TDAH e Autismo" className="tea-bg flex flex-col min-h-screen w-full overflow-x-hidden">
        ...
        <div className="flex-grow w-full relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-0 w-full">
            <div className="bg-gradient-to-r from-[#FFB84D] via-[#F4A261] to-[#FFB84D] py-8 px-6 relative overflow-hidden">
              ...
              <div className="relative z-10 max-w-4xl mx-auto">
                <h2 className="text-[#2B88D9] text-3xl md:text-4xl font-light mb-6 tracking-wide text-center">
                  🦕 Brincar com propósito <span className="text-[#FF8C42] font-serif italic text-5xl">&</span> crescer com autonomia
                </h2>
                <p className="text-[#2B88D9] text-lg font-semibold mb-4 text-center">
                  🎯 Cupom: <span className="text-white bg-[#2B88D9] px-4 py-1 rounded-md font-bold">TEA15</span> 15% OFF em sensoriais e foco
                </p>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
                  <div className="w-full sm:w-auto">
                    <h3 className="text-3xl sm:text-4xl font-bold text-[#2B88D9] mb-1 whitespace-nowrap">Acolhimento</h3>
                    <p className="text-xs sm:text-sm text-[#6B7280]">Curadoria sensorial e afetiva</p>
                  </div>
                  <span className="text-4xl sm:text-5xl text-[#FF8C42] font-serif italic self-center">&</span>
                  <div className="w-full sm:w-auto">
                    <h3 className="text-3xl sm:text-4xl font-bold text-[#2B88D9] mb-1 whitespace-nowrap">Especialistas</h3>
                    <p className="text-xs sm:text-sm text-[#6B7280]">TEA, TDAH e autismo</p>
                  </div>
                  <span className="text-xl sm:text-2xl text-[#6B7280] font-medium self-center">com</span>
                  <div className="w-full sm:w-auto">
                    <h3 className="text-2xl sm:text-3xl font-bold text-[#2B88D9] mb-1 whitespace-nowrap">Frete Local</h3>
                    <p className="text-xs sm:text-sm text-[#6B7280]">São Vicente, Santos e Praia Grande</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Promo Ticker */}
          <div className="bg-[#2B88D9] text-white py-3 overflow-hidden relative w-full">
            ...
            <div className="max-w-7xl mx-auto px-6 py-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
                <div className="flex items-start justify-center md:justify-start gap-3">
                  <div>
                    <p className="text-[#2B88D9] font-semibold mb-1"><span className="text-[#FF8C42]">Envio</span> rápido na Baixada Santista</p>
                    <p className="text-[#6B7280] text-sm">🚚 Frete grátis para São Vicente, Santos e Praia Grande.</p>
                  </div>
                </div>
                <div className="flex items-start justify-center gap-3">
                  <div>
                    <p className="text-[#2B88D9] font-semibold mb-1"><span className="text-[#FF8C42]">Curadoria</span> terapêutica</p>
                    <p className="text-[#6B7280] text-sm">Brinquedos por finalidade para TEA e TDAH.</p>
                  </div>
                </div>
                <div className="flex items-start justify-center md:justify-end gap-3">
                  <div>
                    <p className="text-[#2B88D9] font-semibold mb-1"><span className="text-[#FF8C42]">Atendimento</span> acolhedor</p>
                    <p className="text-[#6B7280] text-sm">Equipe especialista em neurodiversidade.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <nav className="bg-white/95 backdrop-blur border-y border-[#87CEEB] w-full">
            <div className="max-w-7xl mx-auto px-6 py-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                <div>
                  <p className="text-xs uppercase tracking-widest text-[#FF8C42]">Mega Menu TEA & TDAH</p>
                  <h3 className="text-2xl font-semibold text-[#2B88D9]">Encontre brinquedos por finalidade</h3>
                </div>
                <div className="flex flex-wrap gap-3">
                  <button onClick={() => setQuizOpen(true)} className="px-5 py-2 rounded-full bg-[#2B88D9] text-white text-sm font-semibold hover:bg-[#2C5F7D] transition-colors">Fazer quiz rápido</button>
                  <Link to="/collections/all" className="px-5 py-2 rounded-full border border-[#2B88D9] text-[#2B88D9] text-sm font-semibold hover:bg-[#2B88D9] hover:text-white transition-colors">Ver todos os brinquedos</Link>
                </div>
              </div>
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-[#F8F9FA] rounded-2xl p-5 border border-[#87CEEB]">
                  ...
                  <ul className="space-y-2 text-sm text-[#374151]">
                    ...
                    <li><Link to="/search?q=brinquedo%20calmante" className="hover:text-[#FF8C42]">Calmantes e relaxamento</Link></li>
                    <li><Link to="/search?q=luz%20sensorial" className="hover:text-[#FF8C42]">Luzes e estímulos visuais</Link></li>
                ...
                <div className="bg-[#F8F9FA] rounded-2xl p-5 border border-[#87CEEB]">
                  ...
                  <ul className="space-y-2 text-sm text-[#374151]">
                    ...
                    <li><Link to="/search?q=memoria%20visual" className="hover:text-[#FF8C42]">Memória e planejamento</Link></li>
                    <li><Link to="/search?q=organizacao%20tdah" className="hover:text-[#FF8C42]">Organização para TDAH</Link></li>
                ...
                <div className="bg-[#F8F9FA] rounded-2xl p-5 border border-[#87CEEB]">
                  ...
                  <ul className="space-y-2 text-sm text-[#374151]">
                    ...
                    <li><Link to="/search?q=cartoes%20visuais" className="hover:text-[#FF8C42]">Cartões visuais</Link></li>
                    <li><Link to="/search?q=linguagem%20expressiva" className="hover:text-[#FF8C42]">Linguagem expressiva</Link></li>
                ...
                <div className="bg-[#F8F9FA] rounded-2xl p-5 border border-[#87CEEB]">
                  ...
                  <ul className="space-y-2 text-sm text-[#374151]">
                    ...
                    <li><Link to="/search?q=motricidade%20fina" className="hover:text-[#FF8C42]">Motricidade fina</Link></li>
                    <li><Link to="/search?q=autonomia%20diaria" className="hover:text-[#FF8C42]">Autonomia diária</Link></li>
                    <li><Link to="/search?q=brinquedos%20cooperativos" className="hover:text-[#FF8C42]">Brincadeiras cooperativas</Link></li>
                  </ul>
                </div>
              </div>
            </div>
          </nav>
          <div className="bg-[#2B88D9] text-white py-3 w-full">
          ...
          <section className="mb-12 sm:mb-16 md:mb-20 w-full px-0">
            <div className="max-w-7xl mx-auto mt-4 sm:mt-8 px-2 sm:px-4 md:px-6 w-full">
              <div className="relative h-64 sm:h-80 md:h-96 lg:h-[70vh] overflow-hidden rounded-[10px] shadow-xl sm:shadow-2xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-[#2C5F7D]/70 via-[#2C5F7D]/40 to-transparent z-10"></div>
                <div className="absolute inset-0 z-20 flex flex-col justify-center px-6 sm:px-8 md:px-16">
                  ...
                  <p className="text-[#FFB84D] text-sm sm:text-lg md:text-xl tracking-wider mb-4 sm:mb-6">
                    Curadoria terapêutica por finalidade, com acolhimento e diversão.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    <Link to="/collections/all" className="inline-block border-2 border-[#FFB84D] bg-[#2B88D9] text-white px-6 sm:px-10 py-2 sm:py-3 rounded-full hover:bg-[#FFB84D] hover:text-[#2B88D9] hover:border-[#2B88D9] transition-all font-semibold tracking-wider w-fit text-xs sm:text-base">
                      Ver coleções
                    </Link>
                    <button onClick={() => setQuizOpen(true)} className="inline-block border-2 border-white/70 text-white px-6 sm:px-10 py-2 sm:py-3 rounded-full hover:bg-white hover:text-[#2B88D9] transition-all font-semibold tracking-wider w-fit text-xs sm:text-base">
                      Fazer quiz rápido
                    </button>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
              <div className="relative h-72 sm:h-80 md:h-96 overflow-hidden rounded-[10px] shadow-xl group">
                <img 
                  ...
                  decoding="async"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#2B88D9]/85 via-transparent to-transparent"></div>
                <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8 right-6 sm:right-8 text-white">
                  ...
                  <p className="text-[#FFB84D] mb-4 text-sm sm:text-base">Texturas, luzes e autorregulação com segurança</p>
                  <Link to="/search?q=brinquedos%20sensoriais" className="inline-block bg-white text-[#2B88D9] px-6 sm:px-8 py-2 sm:py-3 rounded-full font-semibold hover:bg-[#FFB84D] hover:text-[#2B88D9] transition-all text-sm sm:text-base">Explorar</Link>
                </div>
              </div>
              <div className="relative h-72 sm:h-80 md:h-96 overflow-hidden rounded-[10px] shadow-xl group">
                <img 
                  ...
                  decoding="async"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#2B88D9]/80 via-transparent to-transparent"></div>
                <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8 right-6 sm:right-8 text-white">
                  <h2 className="text-2xl sm:text-3xl font-light mb-2 tracking-wide">Foco e Atenção</h2>
                  <p className="text-[#FFB84D] mb-4 text-sm sm:text-base">Jogos de memória, organização e autocontrole</p>
                  <Link to="/search?q=foco%20tdah" className="inline-block bg-white text-[#2B88D9] px-6 sm:px-8 py-2 sm:py-3 rounded-full font-semibold hover:bg-[#FFB84D] hover:text-[#2B88D9] transition-all text-sm sm:text-base">Explorar</Link>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white py-12 sm:py-16 mb-20 w-full">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
                <div>
                  <h2 className="text-[#2B88D9] text-2xl sm:text-3xl md:text-4xl font-light tracking-wide">Queridinhos até R$ 100</h2>
                  <p className="text-[#6B7280] text-sm sm:text-base">Seleção acessível para estímulo sensorial, foco e autonomia</p>
                </div>
                <Link to="/search?q=pre%C3%A7o%3A%3C100" className="text-[#FF8C42] text-sm font-semibold hover:text-[#F4A261]">Ver todos →</Link>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
                {under100Products.map((p) => (
                  <Link key={p.id} to={`/products/${getProductHandle(p.handle)}`} className="group">
                    <div className="relative aspect-square mb-3 sm:mb-4 overflow-hidden rounded-[10px] bg-[#F8F9FA] shadow-md sm:shadow-lg group-hover:shadow-xl transition-shadow">
                      {p.featuredImage && (
                        <Image 
                    ...
                    <div className="text-center px-2">
                      <p className="text-[#FF8C42] text-xs tracking-widest mb-1 uppercase font-semibold line-clamp-1">{p.vendor || 'BrinqueTEAndo'}</p>
                      <h3 className="text-[#2C5F7D] font-light mb-2 hover:text-[#2B88D9] transition-colors text-xs sm:text-sm line-clamp-2">{p.title}</h3>
                      <Money data={p.priceRange.minVariantPrice} className="text-[#374151] font-medium text-xs sm:text-sm"/>
                    </div>
                  </Link>
                ))}
              </div>
          ...
          <section className="bg-white py-12 sm:py-20 mb-20 w-full">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              <h2 className="text-[#2B88D9] text-2xl sm:text-3xl md:text-4xl font-light text-center mb-8 sm:mb-12 tracking-wide">Faixas de valor acessíveis</h2>
                  ...
                  <Link key={item.title} to={item.url} className="group">
                    <div className="relative bg-gradient-to-br from-[#2B88D9] to-[#87CEEB] text-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl text-center transition-all duration-300 hover:scale-110 hover:shadow-2xl" 
                      ...
                      <div className="relative z-10 pt-3 sm:pt-4 flex-grow flex flex-col justify-center">
                        ...
                        <p className="text-[#FFB84D] text-xs tracking-widest uppercase font-bold">{item.subtitle}</p>
                      </div>
                    </div>
                  </Link>
                ))}
                  ...
                  <div className="relative z-10 transform -rotate-6 hover:rotate-0 transition-transform duration-500 w-full max-w-[340px] sm:max-w-[400px]">
                    <div className="bg-gradient-to-br from-[#2B88D9] to-[#2C5F7D] rounded-xl p-5 sm:p-6 shadow-2xl border-2 border-[#FFB84D] w-full aspect-[1.586/1] flex flex-col justify-between">
                      <div className="flex items-center gap-2 sm:gap-3">
                        <svg className="w-6 h-6 sm:w-8 sm:h-8 text-[#FFB84D] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                      ...
                      <div className="space-y-1 my-3 sm:my-4">
                        ...
                        <p className="text-[#FFB84D] text-xs">MEMBRO DESDE 2024</p>
                      </div>
                      <div className="flex justify-between items-end">
                        <div>
                          <p className="text-[#FFB84D] text-xs uppercase">RESPONSÁVEL</p>
                          <p className="text-white font-semibold text-sm sm:text-base">SUA FAMÍLIA</p>
                        </div>
                        <div className="text-right">
                          <p className="text-[#FFB84D] text-xs uppercase">PONTOS</p>
          ...
          <section className="bg-white py-12 sm:py-20 mb-20 w-full">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              <h2 className="text-[#2C5F7D] text-2xl sm:text-3xl md:text-4xl font-light text-center mb-4 tracking-wide">O que as famílias dizem</h2>
              <p className="text-[#6B7280] text-center mb-8 sm:mb-12 text-sm sm:text-base">Milhares de famílias já encontraram o brinquedo certo</p>
                    ...
                    <div className="bg-white rounded-[10px] shadow-xl p-6 sm:p-8 max-w-3xl mx-auto border border-[#87CEEB]">
                      <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                        <img 
                            ...
                            className="w-12 h-12 sm:w-16 sm:h-16 rounded-full object-cover border-2 border-[#FFB84D]" 
                            width="64" 
                            height="64"
                            loading="lazy"
                            decoding="async"
                        />
                        <div>
                          <p className="font-semibold text-[#2C5F7D] text-sm sm:text-base">{testimonial.name}</p>
                          <div className="flex gap-1">
                            {Array.from({length: testimonial.rating}, (_, i) => `${testimonial.name}-star-${i}`).map((starId) => (
                              <svg key={starId} className="w-4 h-4 sm:w-5 sm:h-5 text-[#FFB84D]" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                            ))}
                          </div>
                        </div>
                      </div>
                      <p className="text-[#374151] text-base sm:text-lg italic leading-relaxed">{testimonial.text}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <section className="bg-gradient-to-b from-white to-[#87CEEB] py-16 sm:py-20 mb-20 w-full">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full">
              ...
              <p className="text-[#6B7280] text-center mb-12 text-sm sm:text-base mx-auto">
                Entrega rápida e cuidadosa para famílias neurodiversas da região
              </p>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
                <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-xl transition-shadow">
                  <div className="text-4xl mb-4">🚚</div>
                  <h3 className="text-xl font-semibold text-[#2C5F7D] mb-3">São Vicente</h3>
                ...
                <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-xl transition-shadow">
                  <div className="text-4xl mb-4">🧩</div>
                  <h3 className="text-xl font-semibold text-[#2C5F7D] mb-3">Santos</h3>
                  <p className="text-[#6B7280] text-sm leading-relaxed">
                ...
                <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-xl transition-shadow">
                  <div className="text-4xl mb-4">🦕</div>
                  <h3 className="text-xl font-semibold text-[#2C5F7D] mb-3">Praia Grande</h3>
                  <p className="text-[#6B7280] text-sm leading-relaxed">
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 mb-12 w-full">
            <h2 className="text-[#2C5F7D] text-2xl sm:text-3xl md:text-4xl font-light text-center mb-8 sm:mb-12 tracking-wide">Coleções por necessidade</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <Link to="/search?q=brinquedos%20sensoriais" className="group relative h-64 sm:h-72 md:h-80 overflow-hidden rounded-[10px] shadow-lg hover:shadow-2xl transition-shadow">
                <img 
                  ...
                  height="800"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#2C5F7D]/90 via-transparent to-transparent"></div>
                <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                  ...
                  <span className="text-[#FFB84D] text-xs sm:text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity">Ver coleção →</span>
                </div>
              </Link>
          ...
          <section className="bg-white py-12 sm:py-16 md:py-20 mb-16 sm:mb-20 w-full">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              <h2 className="text-[#2C5F7D] text-2xl sm:text-3xl md:text-4xl font-light text-center mb-8 sm:mb-12 tracking-wide">Destaques com propósito</h2>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          ...
          {quizOpen && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#2C5F7D]/70 px-4">
              <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full p-6 sm:p-8">
                <div className="flex items-start justify-between gap-4 mb-4">
                  <div>
                    <p className="text-xs uppercase tracking-widest text-[#FF8C42] mb-2">Quiz rápido</p>
                    <h3 className="text-2xl sm:text-3xl font-semibold text-[#2B88D9]">Qual é a principal necessidade hoje?</h3>
                  </div>
                  <button onClick={() => setQuizOpen(false)} className="text-[#374151] hover:text-[#2C5F7D] font-semibold">
                    Fechar
                  </button>
                </div>
          ...
          {chatOpen && (
            <div className="fixed bottom-24 right-6 z-40 w-80 max-w-[90vw]">
              <div className="bg-white border border-[#87CEEB] shadow-2xl rounded-2xl overflow-hidden">
                ...
                <div className="p-4">
                  <p className="text-sm text-[#2C5F7D] mb-3">Oi! Sou especialista em neurodiversidade e posso orientar a escolha do brinquedo ideal.</p>
                  <div className="flex flex-col gap-2">
                    <button onClick={() => setQuizOpen(true)} className="w-full bg-[#2B88D9] text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-[#2C5F7D] transition-colors">
                      Fazer quiz agora
                    </button>
                    <Link to="/collections/all" className="w-full text-center border border-[#2B88D9] text-[#2B88D9] text-sm font-semibold px-4 py-2 rounded-lg hover:bg-[#2B88D9] hover:text-white transition-colors">
          ...
          <button onClick={() => setChatOpen((open) => !open)} className="fixed bottom-6 right-6 z-40 bg-[#2B88D9] text-white px-4 py-3 rounded-full shadow-xl hover:bg-[#2C5F7D] transition-colors font-semibold text-sm">
...
function BrinqueTEAndoFooter() {
  return (
    ...
    >
      ...
      {/* Newsletter Section */}
      <div className="relative border-b border-[#F4A261]/20 w-full">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-4xl font-light text-[#F4A261] mb-3 tracking-wide">
            ...
            <form className="flex flex-col sm:flex-row gap-3 w-full">
              <input
                ...
                className="flex-1 bg-white/10 border border-[#F4A261]/30 text-white placeholder:text-white/60 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F4A261]"
              />
              <button type="submit" className="bg-[#F4A261] text-[#2C5F7D] px-6 py-3 rounded-lg font-semibold hover:bg-[#FFB84D] transition-colors">
                Quero receber
              </button>
            </form>
          </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="inline-block mb-6 group">
              <div className="text-5xl font-serif text-white tracking-[0.3em] group-hover:text-[#F4A261] transition-colors duration-300">
                BRINQUETEANDO
              </div>
              <div className="h-1 w-0 group-hover:w-full bg-gradient-to-r from-[#F4A261] to-transparent transition-all duration-500 mt-2"></div>
            </Link>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                <div className="w-8 h-8 rounded-full bg-[#F4A261]/20 flex items-center justify-center flex-shrink-0">
          ...
          {/* Shop Links */}
          <div>
            <h4 className="text-[#F4A261] text-sm font-bold mb-6 uppercase tracking-widest relative inline-block">
              Explorar coleções
              <div className="absolute -bottom-2 left-0 w-12 h-0.5 bg-gradient-to-r from-[#F4A261] to-transparent"></div>
            </h4>
            <ul className="space-y-3">
              <li>
                <Link to="/search?q=novidades%20sensoriais" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Novidades sensoriais
                </Link>
              </li>
              <li>
                <Link to="/search?q=foco%20tdah" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Foco e atenção
                </Link>
              </li>
              <li>
                <Link to="/search?q=comunicacao%20alternativa" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Comunicação e linguagem
                </Link>
              </li>
              <li>
                <Link to="/search?q=rotina%20visual" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Rotina e autonomia
                </Link>
              </li>
              <li>
                <Link to="/search?q=habilidades%20sociais" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Habilidades sociais
                </Link>
              </li>
              <li>
                <Link to="/search?q=coordenacao%20motora" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Coordenação motora
                </Link>
              </li>
              <li>
                <Link to="/blogs/news" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Dicas e conteúdos
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/pages/faq" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  FAQ
                </Link>
              </li>
              <li>
                <Link to="/pages/returns" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Trocas e devoluções
                </Link>
              </li>
              <li>
                <Link to="/pages/shipping-policy" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Política de frete
                </Link>
              </li>
              <li>
                <Link to="/pages/contact" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Fale conosco
                </Link>
              </li>
              <li>
                <Link to="/pages/1-year-warranty" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/pages/our-story" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Nossa história
                </Link>
              </li>
              <li>
                <Link to="/pages/careers" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Trabalhe conosco
                </Link>
              </li>
              <li>
                <Link to="/pages/press" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Imprensa
                </Link>
              </li>
              <li>
                <Link to="/pages/privacy-policy" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Política de privacidade
                </Link>
              </li>
              <li>
                <Link to="/pages/terms-of-service" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Termos de serviço
                </Link>
              </li>
              <li>
                <Link to="/pages/cookie-policy" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
                  Política de cookies
                </Link>
              </li>
              <li>
                <Link to="/pages/data-sharing-opt-out" className="text-gray-300 hover:text-[#F4A261] text-sm transition-all duration-200 hover:translate-x-1 inline-block">
        ...
        <div className="border-t border-[#F4A261]/20 pt-12">
          <div className="grid md:grid-cols-2 gap-8 items-center mb-8">
            
            {/* Social Media */}
            <div>
              <h4 className="text-[#F4A261] text-sm font-semibold mb-4 uppercase tracking-wider">
              ...
              <div className="flex gap-3">
                <a 
                  ...
                  className="w-11 h-11 flex items-center justify-center bg-white/5 backdrop-blur-sm border border-[#F4A261]/30 rounded-lg hover:bg-[#F4A261] hover:border-[#F4A261] transition-all duration-300 hover:scale-110 group"
                  aria-label="Facebook"
                >
                  <svg className="w-5 h-5 text-[#F4A261] group-hover:text-[#2C5F7D]" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-right">
              ...
              <div className="flex justify-end gap-2 flex-wrap">
                {['Pix', 'Boleto', 'Visa', 'Mastercard', 'Amex'].map((method) => (
                  <div 
                    key={method}
                    className="px-3 py-2 bg-white/10 backdrop-blur-sm border border-[#F4A261]/20 rounded text-xs text-gray-300 font-medium"
                  >
                    {method}
                  </div>
                ))}
          ...
          {/* Copyright */}
          <div className="pt-8 border-t border-[#F4A261]/20">
      ...
      <div className="h-1 bg-gradient-to-r from-transparent via-[#F4A261] to-transparent"></div>
    </footer>
  );
}
