                ...
                {[
                  ...
                  <Link key={idx} to={item.url} className="group">
                    <div className="relative bg-gradient-to-br from-[#3292D8] to-[#21388D] text-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl text-center transition-all duration-300 hover:scale-110 hover:shadow-2xl" 
                      ...
                      <div style={{position:'absolute', top:12, left:'50%', transform:'translateX(-50%)', display:'flex', gap:'8px', fontSize:'12px', opacity:0.7}}>
                        <span>✦</span>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a 
                  ...
                  aria-label="Facebook"
                >
                  <svg width="20" height="20" className="text-[#DEC91F] group-hover:text-[#21388D]" fill="currentColor" viewBox="0 0 24 24">
